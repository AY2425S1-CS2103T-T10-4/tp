...
public class CommandTestUtil {
    ...
    public static final String INVALID_RELATIONSHIP_DESC = " " + PREFIX_RELATIONSHIP
            + "Father1"; // '1' is not allowed in relationships
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                .withPhone(VALID_PHONE_AMY).withEmail(VALID_EMAIL_AMY).withRelationship(VALID_RELATIONSHIP_AMY).build();
        DESC_BOB = new EditPersonDescriptorBuilder().withName(VALID_NAME_BOB)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_BOB).withRelationship(VALID_RELATIONSHIP_BOB).build();
    }
