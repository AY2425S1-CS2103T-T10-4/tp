...
with(this){return _c('p',[_v("The "),_c('strong',[_v("API")]),_v(" of this component is specified in "),_c('a',{attrs:{"href":"https://github.com/AY2425S1-CS2103T-T10-4/tp/tree/master/src/main/java/seedu/address/ui/Ui.java"}},[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Ui.java")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("API")]),_v(" : "),_c('a',{attrs:{"href":"https://github.com/AY2425S1-CS2103T-T10-4/tp/tree/master/src/main/java/seedu/address/logic/Logic.java"}},[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Logic.java")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("API")]),_v(" : "),_c('a',{attrs:{"href":"https://github.com/AY2425S1-CS2103T-T10-4/tp/tree/master/src/main/java/seedu/address/model/Model.java"}},[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model.java")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("API")]),_v(" : "),_c('a',{attrs:{"href":"https://github.com/AY2425S1-CS2103T-T10-4/tp/tree/master/src/main/java/seedu/address/storage/Storage.java"}},[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Storage.java")])])])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Priority")]),_v(" "),_c('th',[_v("As a …​")]),_v(" "),_c('th',[_v("I want to …​")]),_v(" "),_c('th',[_v("So that I can…​")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("As a user")]),_v(" "),_c('td',[_v("add contact information of the family member")]),_v(" "),_c('td',[_v("I can retrieve their contact information")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("As a user")]),_v(" "),_c('td',[_v("add the relationship of the family members")]),_v(" "),_c('td',[_v("I can know the relationship between people")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("As a user")]),_v(" "),_c('td',[_v("update the information of family members in the contact list")]),_v(" "),_c('td',[_v("I can keep the latest information of my family")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("As a user")]),_v(" "),_c('td',[_v("add events tied to family members (e.g birthdays)")]),_v(" "),_c('td',[_v("I can set reminders on that date so that I don't ever forget about it")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("As an organizer")]),_v(" "),_c('td',[_v("track RSVPs and attendance for each event")]),_v(" "),_c('td',[_v("I know who is attending the event and can plan accordingly")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("As an organizer")]),_v(" "),_c('td',[_v("schedule family events")]),_v(" "),_c('td',[_v("I can plan and coordinate events")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("As an organizer")]),_v(" "),_c('td',[_v("see the contact list of family members")]),_v(" "),_c('td',[_v("I know whose contacts that I have not added yet and add them")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("As an organizer")]),_v(" "),_c('td',[_v("update the event's information after creating it")]),_v(" "),_c('td',[_v("attendees can see the updated event details")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("As an organizer")]),_v(" "),_c('td',[_v("delete an event")]),_v(" "),_c('td',[_v("I can cancel an event")])])])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("(For all use cases below, the "),_c('strong',[_v("System")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("LegacyLink")]),_v(" and the "),_c('strong',[_v("Actor")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("user")]),_v(", unless specified otherwise)")])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case 1: Add contact")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User enters name, phone number, email and relationship of the contact.")])]),_v(" "),_c('li',[_c('p',[_v("User confirms details of the contact.")])]),_v(" "),_c('li',[_c('p',[_v("System adds the contact.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. User enters an invalid name, phone number, email, and/or relationship.")]),_v(" "),_c('p',[_v("Use case resumes at step 1.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case 2: Delete contact")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User views all contacts "),_c('a',{attrs:{"href":"#use-case-3-view-all-contacts"}},[_v("UC-3")]),_v(".")])]),_v(" "),_c('li',[_c('p',[_v("System shows a list of persons.")])]),_v(" "),_c('li',[_c('p',[_v("User requests to delete a specific contact in the list.")])]),_v(" "),_c('li',[_c('p',[_v("System deletes the person.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("3a. The given index is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. System shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])])])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"use-case-3-view-all-contacts"}},[_c('strong',[_v("Use case 3: View all contacts")]),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#use-case-3-view-all-contacts","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to view the list of contacts.")])]),_v(" "),_c('li',[_c('p',[_v("The system displays a list of all contacts.")])]),_v(" "),_c('li',[_c('p',[_v("User can scroll through the list to see all the contact listed.")])]),_v(" "),_c('li',[_c('p',[_v("User can click on a contact to view more details.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case 4: Update information of contact")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User lists all contacts "),_c('a',{attrs:{"href":"#use-case-3-view-all-contacts"}},[_v("UC-3")]),_v(".")])]),_v(" "),_c('li',[_c('p',[_v("User selects contact to update.")])]),_v(" "),_c('li',[_c('p',[_v("User can edit name / phone number / email / relationship of contact.")])]),_v(" "),_c('li',[_c('p',[_v("System registers the changes.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The given index is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. System shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])]),_v(" "),_c('li',[_c('p',[_v("3a. The changed details are invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. System shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 3.")])])])])])}
},function anonymous(
) {
with(this){return _c('pre',[_c('code',{pre:true},[_v("*a1. System does not update any contact details.\nUse case ends.\n")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case 5: Add event")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User enters name, start date, end date, location of the event.")])]),_v(" "),_c('li',[_c('p',[_v("User confirms the details of the event.")])]),_v(" "),_c('li',[_c('p',[_v("System adds the event.")])]),_v(" "),_c('li',[_c('p',[_v("User is given feedback that the event is added successfully.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. User enters index of persons attending.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])]),_v(" "),_c('li',[_c('p',[_v("1b. The inputs are invalid")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1b1. System shows an error message")]),_v(" "),_c('p',[_v("Use case resumes at step 1.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case 6: Delete an event")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Preconditions:")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("Event list must have at least one event.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User lists all events "),_c('a',{attrs:{"href":"#use-case-7-view-all-events"}},[_v("UC-7")]),_v(".")])]),_v(" "),_c('li',[_c('p',[_v("System shows a list of events.")])]),_v(" "),_c('li',[_c('p',[_v("User selects an event to delete.")])]),_v(" "),_c('li',[_c('p',[_v("User confirms their intention and the event is deleted.")])]),_v(" "),_c('li',[_c('p',[_v("User is given feedback that the event is deleted successfully.")])]),_v(" "),_c('li',[_c('p',[_v("User no longer sees the event in the event list.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("3a. The given index is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. System shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 3.")])])])]),_v(" "),_c('li',[_c('p',[_v("4a. If the User cancels deleting the event, the event is kept and the use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"use-case-7-view-all-events"}},[_v("Use Case 7: View All Events"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#use-case-7-view-all-events","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User lists all events.")])]),_v(" "),_c('li',[_c('p',[_v("The system displays a list of all events.")])]),_v(" "),_c('li',[_c('p',[_v("User can scroll through the list to see all the events listed.")])]),_v(" "),_c('li',[_c('p',[_v("User can click on an event to view more details.")]),_v(" "),_c('p',[_v("Use case ends")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case 8: Update event information")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User views all events "),_c('a',{attrs:{"href":"#use-case-7-view-all-events"}},[_v("UC-7")]),_v(".")])]),_v(" "),_c('li',[_c('p',[_v("User selects event to edit.")])]),_v(" "),_c('li',[_c('p',[_v("User changes the relevant event details.")])]),_v(" "),_c('li',[_c('p',[_v("User saves the information.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The given index is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2a1. System shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])]),_v(" "),_c('li',[_c('p',[_v("3a. User does not change event details.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])]),_v(" "),_c('li',[_c('p',[_v("3b. The changed details are invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3b1. System shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 3.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('em',[_v("{More to be added}")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("List all persons")]),_v(" "),_c('ol',[_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list -p")]),_v(" (must be an exact match)\nExpected: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Listed all person")]),_v(" is shown in the status message. Tabs switched to Contacts.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Adding a person")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Prerequisites: List all persons using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list -p")]),_v(" command. Multiple persons in the list.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add -n John Doe -p 98765432 -e johnd@example.com -rs Brother")]),_c('br'),_v("\nExpected: Person with name "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("John Doe")]),_v(" with phone number "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("98765432")]),_v(", email "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("johnd@example.com")]),_v(" and relationship of "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Brother")]),_v(" is added. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("New person added: John Doe; Phone: 98765432; Email: johnd@example.com; Relationship: Brother")]),_v(" is shown in the status message.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add")]),_c('br'),_v("\nExpected: No person is added to the contact. Error details shown in the status message. Status bar remains the same.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add 0")]),_v(" "),_c('br'),_v("\nExpected: No person is added to the contact. Error details shown in the status message. Status bar remains the same.")])]),_v(" "),_c('li',[_c('p',[_v("Test case (Invalid name): "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add -n John_Doe -p 98765432 -e johnd@example.com -rs Brother")]),_v(" "),_c('br'),_v("\nExpected: No person is added to the contact. Error details shown in the status message. Status bar remains the same.")])]),_v(" "),_c('li',[_c('p',[_v("Test case (Invalid phone number): "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add -n John Doe -p 1 -e johnd@example.com -rs Brother")]),_v(" "),_c('br'),_v("\nExpected: No person is added to the contact. Error details shown in the status message. Status bar remains the same.")])]),_v(" "),_c('li',[_c('p',[_v("Test case (Invalid email): "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add -n John Doe -p 98765432 -e johndexample -rs Brother")]),_v(" "),_c('br'),_v("\nExpected: No person is added to the contact. Error details shown in the status message. Status bar remains the same.")])]),_v(" "),_c('li',[_c('p',[_v("Test case (Invalid relationship): "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add -n John Doe -p 98765432 -e johnd@example.com -rs Brother333")]),_v(" "),_c('br'),_v("\nExpected: No person is added to the contact. Error details shown in the status message. Status bar remains the same.")])]),_v(" "),_c('li',[_c('p',[_v("Test case (Multiple values for fields): "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add -n John Doe -p 98765432 -e johnd@example.com -rs Brother -rs Brother")]),_v(" "),_c('br'),_v("\nExpected: No person is added to the contact. Error details shown in the status message. Status bar remains the same.")])]),_v(" "),_c('li',[_c('p',[_v("Test case (Missing fields): "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add -n John Doe -e johnd@example.com -rs Brother")]),_v(" "),_c('br'),_v("\nExpected: No person is added to the contact. Error details shown in the status message. Status bar remains the same.")])])])]),_v(" "),_c('li',[_c('p',[_v("Adding a duplicate person")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Prerequisites: List all persons using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list -p")]),_v(" command. Person with name "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("John Doe")]),_v(" with phone number "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("98765432")]),_v(", email "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("johnd@example.com")]),_v(" and relationship of "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Brother")]),_v(" already exists.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add -n John Doe -p 98765432 -e johnd@example.com -rs Brother")]),_v("\nExpected: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("This person already exists in the address book")]),_v(" is displayed.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Editing a person, where result does not cause duplicate persons.")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Prerequisites: List all persons using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list -p")]),_v(" command. Multiple persons in the list.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 1 -n Bernice Tan")]),_c('br'),_v("\nExpected: The name of the first person is edited to "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Bernice Tan")]),_v(". Details of the added person shown in the status message.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 1 -p 123123123")]),_c('br'),_v("\nExpected: The phone number of the first person is edited to "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("123123123")]),_v(". Details of the added person shown in the status message.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 1 -e johnd@example.com")]),_c('br'),_v("\nExpected: The email of the first person is edited to "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("johnd@example.com")]),_v(". Details of the added person shown in the status message.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 1 -rs Sister")]),_c('br'),_v("\nExpected: The name of the first person is edited to "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Sister")]),_v(". Details of the added person shown in the status message. Timestamp in the status bar is updated.")])]),_v(" "),_c('li',[_c('p',[_v("Other correct edit commands to try (more than 1 field edited): "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 1 -p 12345678 -rs Sister")]),_v(" "),_c('br'),_v("\nExpected: The phone number and relationship of the first person is edited to "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("12345678")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Sister")]),_v(". Details of the added person shown in the status message.")])]),_v(" "),_c('li',[_c('p',[_v("Test case (No fields provided): "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 1")]),_c('br'),_v("\nExpected: No person is edited in the contact. Error details shown in the status message. Status bar remains the same.")])]),_v(" "),_c('li',[_c('p',[_v("Test case (Multiple values for fields): "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 1 -n John -n Doe")]),_c('br'),_v("\nExpected: No person is edited in the contact. Error details shown in the status message. Status bar remains the same.")])]),_v(" "),_c('li',[_c('p',[_v("Other incorrect add commands to try: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit x")]),_v(" (where x is larger than the list size), "),_c('br'),_v("\nExpected: No person is edited in the contact. Error details shown in the status message. Status bar remains the same.")])])])]),_v(" "),_c('li',[_c('p',[_v("Editing a person, where result causes duplicate persons.")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Prerequisites: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add -n Johnny Doe -p 98765432 -e johnd@example.com -rs Brother")]),_v(" followed by "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add -n John Doe -p 98765432 -e johnd@example.com -rs Brother")])])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 1 -n John Doe")]),_c('br'),_v("\nExpected: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("This person already exists in the address book.")]),_v(" is shown in the status message.")])]),_v(" "),_c('li',[_c('p',[_v("Other test cases to try: editing 1 or more fields to cause a person to have the same "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("name")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("phone number")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("email")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("relationship")]),_v(" as another person in the list.\nExpected: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("This person already exists in the address book.")]),_v(" is shown in the status message.")])])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"listing-all-events"}},[_v("Listing all events"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#listing-all-events","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Listing all events")]),_v(" "),_c('ol',[_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list -e")]),_v(" (must be an exact match)\nExpected: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Listed all events")]),_v(" is shown in the status message. Tabs switched to Events.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Adding an event")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Prerequisites: List all events using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list -e")]),_v(" command. Multiple events in the list. If adding attendees, attendees must exist in the address book.")])]),_v(" "),_c('li',[_c('p',[_v("Test case (No attendees): "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("event -n Study -sd 2025-01-01 -ed 2025-01-01 -l School")]),_c('br'),_v("\nExpected: Event with name "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Study")]),_v(" with start date "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Jan 01 2025")]),_v(", end date "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Jan 01 2025")]),_v(", location "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("School")]),_v(" is added. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("New event added: Study; Date: 2025-01-01 - 2025-01-01; Location: School; No Attendees.")]),_v(" is shown in the status message.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("event")]),_c('br'),_v("\nExpected: No event is added to the contact. Error details shown in the status message. Status bar remains the same.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("event -n abc")]),_v(" "),_c('br'),_v("\nExpected: No event is added to the contact. Error details shown in the status message. Status bar remains the same.")])]),_v(" "),_c('li',[_c('p',[_v("Test case (Invalid dates): "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("event -n Study -sd 2030-01-01 -ed 2025-01-01 -l School")]),_v(" "),_c('br'),_v("\nExpected: No event is added to the contact. Error details shown in the status message. Status bar remains the same.")])]),_v(" "),_c('li',[_c('p',[_v("Test case (Invalid attendees): "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("event -n Study -sd 2025-01-01 -ed 2025-01-01 -l School -a -10")]),_v(" "),_c('br'),_v("\nExpected: No event is added to the contact. Error details shown in the status message. Status bar remains the same.")])]),_v(" "),_c('li',[_c('p',[_v("Test case (Multiple values for fields): "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("event -n Study -n Event -sd 2025-01-01 -ed 2025-01-01 -l School")]),_v(" "),_c('br'),_v("\nExpected: No event is added to the contact. Error details shown in the status message. Status bar remains the same.")])]),_v(" "),_c('li',[_c('p',[_v("Test case (Missing fields): "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("event -n Study -sd 2025-01-01 -l School")]),_v(" "),_c('br'),_v("\nExpected: No event is added to the contact. Error details shown in the status message. Status bar remains the same.")])])])]),_v(" "),_c('li',[_c('p',[_v("Adding a duplicate event")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Prerequisites: List all events using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list -e")]),_v(" command. Event with name "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Study")]),_v(" with start date "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Jan 01 2025")]),_v(", end date "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Jan 01 2025")]),_v(", location "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("School")]),_v(" already exists.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("event -n Study -sd 2025-01-01 -ed 2025-01-01 -l School")]),_v("\nExpected: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("This event already exists in the event book")]),_v(" is displayed.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Sat, 9 Nov 2024, 17:02:12 GMT+8]")])])])}
}];
